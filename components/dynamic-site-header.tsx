...
export function DynamicSiteHeader({
  ...
  return (
    <header className="group-has-data-[collapsible=icon]/sidebar-wrapper:h-[var(--header-height)] flex min-h-[var(--header-height)] shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear">
